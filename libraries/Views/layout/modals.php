...
<div class="modal" id="modalSignUp">
    <div class="modal-content">
        ...
        <p>Inscrivez vous pour profiter au maximum du super <span class="golden-text">Q</span>ui<span
                class="purple-text">Z</span>!</p>
        ...
        <form action="<?= $tplVars['WWW_URL']; ?>index.php?controller=user&task=create" method="POST">
            ...
            <div class="display_flex">
                <img src="https://images-na.ssl-images-amazon.com/images/M/MV5BNTczMzk1MjU1MV5BMl5BanBnXkFtZTcwNDk2MzAyMg@@._V1_UY256_CR2,0,172,256_AL_.jpg"
                    alt="WillSmith">
                <img src="https://images-na.ssl-images-amazon.com/images/M/MV5BMjUzZTJmZDItODRjYS00ZGRhLTg2NWQtOGE0YjJhNWVlMjNjXkEyXkFqcGdeQXVyMTg4NDI0NDM@._V1_UY256_CR42,0,172,256_AL_.jpg"
                    alt="GalGadot">
                <img src="https://images-na.ssl-images-amazon.com/images/M/MV5BOWViYjUzOWMtMzRkZi00MjNkLTk4M2ItMTVkMDg5MzE2ZDYyXkEyXkFqcGdeQXVyODQwNjM3NDA@._V1_UY256_CR36,0,172,256_AL_.jpg"
                    alt="AdamDriver">
                <img src="https://images-na.ssl-images-amazon.com/images/M/MV5BNjk5NjE5NTczMV5BMl5BanBnXkFtZTcwODI0OTM0NA@@._V1_UY256_CR4,0,172,256_AL_.jpg"
                    alt="Effy">
                <img src="https://images-na.ssl-images-amazon.com/images/M/MV5BOTU2MTI0NTIyNV5BMl5BanBnXkFtZTcwMTA4Nzc3OA@@._V1_UX172_CR0,0,172,256_AL_.jpg"
                    alt="ChrisHemsworth">
            </div>
            <div class="display_flex">
...
<div class="modal" id="modalLogin">
    <div class="modal-content">
        <a href="index.php" class="close">&times;</a>
        <p>Merci de renseigner vos identifiants <span class="golden-text">Q</span>ui<span class="purple-text">Z</span>!
        </p>
