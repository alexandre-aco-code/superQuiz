    ...
    <div class="container display">
        ...
        <nav>
            <ul>
                ...
                <li>
                    <a class="principalHeaderLinks" href=" <?= $tplVars['WWW_URL']; ?>index.php">
                ...
                <li>
                    <a class="principalHeaderLinks" href="<?= $tplVars['WWW_URL']; ?>index.php?controller=topic&task=index&topic=1">
                ...
                <li>
                    <a class="principalHeaderLinks" href="<?= $tplVars['WWW_URL']; ?>index.php?controller=user&task=rankings">
                        <i class="fas fa-globe-africa"></i>
                        Classement</a>
                </li>
                <!-- MENU DE NAVIGATION : MON COMPTE -->
                <li><a class="principalHeaderLinks" href="<?= $tplVars['WWW_URL']; ?>index.php?controller=user&task=infosUser">
